...
namespace DersDemo_Ado_WebDemo.DataLayer {
...
namespace DersDemo_Ado_WebDemo.DataLayer.NorthwindDataSetTableAdapters {
    ...
    public partial class CategoriesTableAdapter : global::System.ComponentModel.Component {
        ...
        public virtual int FillByCategoryID(NorthwindDataSet.CategoriesDataTable dataTable, int CategoryID) {
        ...
        public virtual NorthwindDataSet.CategoriesDataTable GetDataByCategoryID(int CategoryID) {
            this.Adapter.SelectCommand = this.CommandCollection[1];
            this.Adapter.SelectCommand.Parameters[0].Value = ((int)(CategoryID));
            NorthwindDataSet.CategoriesDataTable dataTable = new NorthwindDataSet.CategoriesDataTable();
            this.Adapter.Fill(dataTable);
    ...
    public partial class ProductsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[1] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[1].Connection = this.Connection;
            this._commandCollection[1].CommandText = "SELECT     ProductID, ProductName, SupplierID, CategoryID, QuantityPerUnit, UnitP" +
            ...
            this._commandCollection[2].CommandText = "SELECT     ProductID, ProductName, SupplierID, CategoryID, QuantityPerUnit, UnitP" +
                "rice, UnitsInStock, UnitsOnOrder, ReorderLevel, Discontinued\r\nFROM         Produ" +
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Fill, false)]
        public virtual int FillByCategoryID(NorthwindDataSet.ProductsDataTable dataTable, global::System.Nullable<int> CategoryID) {
            this.Adapter.SelectCommand = this.CommandCollection[1];
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Select, false)]
        public virtual NorthwindDataSet.ProductsDataTable GetDataByCategoryID(global::System.Nullable<int> CategoryID) {
            this.Adapter.SelectCommand = this.CommandCollection[1];
            if ((CategoryID.HasValue == true)) {
                this.Adapter.SelectCommand.Parameters[0].Value = ((int)(CategoryID.Value));
            }
